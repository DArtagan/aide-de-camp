...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Company', fields ['user']
        db.delete_unique(u'companies_company', ['user_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Company', fields ['user']
        db.create_unique(u'companies_company', ['user_id'])
